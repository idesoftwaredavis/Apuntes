...
document.write("<h3>La suma de los dos numeros ingresados es : " + sumar(num1,num2) + "<h3/>" + "<br/>");
document.write("<h3>La resta de los dos numeros ingresados es : " + restar(num1,num2) + "<h3/>");
document.write("<h3>La multiplicacion de los dos numeros ingresados es : " + multiplicar(num1,num2) + "<h3/>");
document.write("<h3>La division de los dos numeros ingresados es : " + dividir(num1,num2) + "<h3/>");
